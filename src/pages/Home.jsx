...
const Home = () => {
  ...
  return (
    <div className="my-10 mx-3 flex gap-6 items-start overflow-x-scroll scrollbar-hide [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] whitespace-nowrap max-h-screen">
      {lists.map((list) => (
